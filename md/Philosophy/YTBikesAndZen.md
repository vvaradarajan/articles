...
<img src="/home/vv/git/articles/img/bikeZen/dork.png" /> 
...
# Endcaps
Found out that end caps generically cap the end of some thing for generally good purposes. Here is the wheel hub end cap:  
<img src="/home/vv/git/articles/img/bikeZen/endCaps.png" />  
Here is a bike wheel without the end cap:  
<img src="/home/vv/git/articles/img/bikeZen/bikeHubNoEndCap.png" />  
Here it is with the end cap:  
<img src="/home/vv/git/articles/img/bikeZen/withEndCap.png" />  
Why the end cap?  
Here the end cap is to prevent dirt entering the hub.. And to act as a spacer between the wheel and the wheel mounting on the bike frame, so that is is less likely that the wheel will rub on some part of the frame.

# Brake cable sleeve
That brake cable sleeve that covers the brake cable.. Here is a picture:  
<img src="/home/vv/git/articles/img/bikeZen/brakeCable.png" />  
What does it do ?  
...
If you don't have wheel caps, make sure you check that your wheels are not rubbing the frame, brakes etc. Besides keep your hub clean by brushing off any dirt.

# Conclusion:  
Translate the above to how to maintain you own body. Think about your joints, organs,nerves, brain and their maintenance and protection. Look into each detail. Eat, exercise, think, creativity all have many Dork disks and end caps. Vitamins, protein, fat, .. in what you eat.. Muscles, lungs, heart, bones, nerves in your exercise.. Logic, learning, emotional well being, sociability, friendliness, mental health in thinking and creativity..
